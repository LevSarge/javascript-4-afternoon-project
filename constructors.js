...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  /*
    ...
    name (a string), genre (a string), and rating 
      (a number within 1-100 that has been averaged out from previous given ratings).
  ...
  */
  ...
  This function should take in 4 parameters called name, age, email, and savedPosts in that order. 
  ...
  User.prototype.removeSavedPost = function(id){
      this.savedPosts = this.savedPosts.filter(savedPosts => savedPosts.id !== id)
  }
  ////////// PROBLEM 7 //////////
  
  // You will continue to use the constructor function you created in problem 5.
  // Write a prototype method for the User constructor function named changePostRating 
  //that will take in two number parameters. 
